...
Shader "Toony Colors Pro 2/User/TCP2 Custom Water"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 Fragment(Varyings input) : SV_Target
			{
				...
				// Shader Properties Sampling
				float4 __albedo = ( tex2D(_BaseMap, input.pack1.xy.xy + frac(_Time.yy * _BaseMap_SC.xy)).rgba );
