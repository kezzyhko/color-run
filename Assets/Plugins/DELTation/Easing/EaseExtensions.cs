    ...
    public static class EaseExtensions
    {
        ...
        public static float GetValue(this Ease ease, float t, float overshoot = 1.70158f)
        {
            ...
            switch (ease)
            {
                ...
                case Ease.InOutCubic: return t < 0.5f ? 4 * t * t * t : 1 - (-2 * t + 2) * (-2 * t + 2) * (-2 * t + 2) / 2;
                case Ease.InQuart: return t * t * t * t;
                case Ease.OutQuart: return 1 - (1 - t) * (1 - t) * (1 - t) * (1 - t);
                case Ease.InOutQuart: return t < 0.5f ? 8 * t * t * t * t : 1 - (-2 * t + 2) * (-2 * t + 2) * (-2 * t + 2) * (-2 * t + 2) / 2;
                case Ease.InQuint: return t * t * t * t * t;
                case Ease.OutQuint: return 1 - (1 - t) * (1 - t) * (1 - t) * (1 - t) * (1 - t);
                case Ease.InOutQuint: return t < 0.5f ? 16 * t * t * t * t * t : 1 - (-2 * t + 2) * (-2 * t + 2) * (-2 * t + 2) * (-2 * t + 2) * (-2 * t + 2) / 2;
                case Ease.InExpo: return t == 0 ? 0 : Pow(2, 10 * t - 10);
                case Ease.OutExpo: return t == 1 ? 1 : 1 - Pow(2, -10 * t);
                case Ease.InOutExpo: return t == 0
                    ? 0
                    : t == 1
                        ? 1
                ...
                case Ease.InOutCirc: return t < 0.5
                    ? (1 - Sqrt(1 - 4 * t * t)) / 2
                    : (Sqrt(1 - (-2 * t + 2) * (-2 * t + 2)) + 1) / 2;
                case Ease.InBack: return (overshoot + 1) * t * t * t - overshoot * t * t;
                case Ease.OutBack: return 1 + (overshoot + 1) * (t - 1) * (t - 1) * (t - 1) + overshoot * (t - 1) * (t - 1);
                case Ease.InOutBack:
                {
                ...
                case Ease.InElastic: return t == 0
                    ? 0
                    : t == 1
                        ? 1
                        : -Pow(2, 10 * t - 10) * Sin((t * 10 - 10.75f) * (2 * PI / 3));
                case Ease.OutElastic: return t == 0
                    ? 0
                    : t == 1
                        ? 1
                ...
                case Ease.InOutBounce: return t < 0.5
